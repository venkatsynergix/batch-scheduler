...
class gsp_schedulerApp_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(8)
invokeTag('render','g',22,['template':("/layouts/header")],-1)
printHtmlPart(6)
invokeTag('layoutBody','g',23,[:],-1)
printHtmlPart(9)
invokeTag('render','g',25,['template':("/layouts/footer")],-1)
printHtmlPart(10)
...
public static final long LAST_MODIFIED = 1408261840559L
