...
class gsp_schedule_jobIntervalcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/schedule-0.1/grails-app/views/jobInterval/create.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('set','g',5,['var':("entityName"),'value':(message(code: 'jobInterval.label', default: 'JobInterval'))],-1)
printHtmlPart(1)
createTagBody(2, {->
createTagBody(3, {->
...
invokeTag('eachError','g',25,['bean':(jobIntervalInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(jobIntervalInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:jobIntervalInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1408240563279L
